...
export default {
  ...
  data() {
    return {
      ...
      copyQueryParams: {},
      table_list: [],
      table_option: [{'prop': 'merchantName', 'type': 'str', 'label': '所属商户名称', 'value': '', 'data': [], 'options': {}}, {'prop': 'purchaseNotesId', 'type': 'str', 'label': '购买须知ID', 'value': '', 'data': [], 'options': {}}, {'prop': 'refMerchantId', 'type': 'str', 'label': '所属商户ID', 'value': '', 'data': [], 'options': {}}, {'prop': 'refUserGroupId', 'type': 'str', 'label': '运营渠道ID', 'value': '', 'data': [], 'options': {}}, {'prop': 'refUserGroupName', 'type': 'str', 'label': '运营渠道名称', 'value': '', 'data': [], 'options': {}}, {'prop': 'templateDetail', 'type': 'str', 'label': '商品详情', 'value': '', 'data': [], 'options': {}}, {'prop': 'templateName', 'type': 'str', 'label': '模板名称', 'value': '', 'data': [], 'options': {}}, {'prop': 'templateType', 'type': 'dict', 'label': '模板类型', 'value': '', 'data': [], 'options': {'dict': {'0': '平台模板 ', '1': '店铺模板'}}}, {'prop': 'unitOrgCode', 'type': 'str', 'label': '子机构编码', 'value': '', 'data': [], 'options': {}}],
    };
  },
  async mounted() {
